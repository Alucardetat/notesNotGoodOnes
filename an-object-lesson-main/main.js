...
mySelfObj.firstName = "Chris"

// Add a `lastName` property and set it to a string.
mySelfObj.lastName = "McConnell"
...
mySelfObj.address.push("1234 Somewhere NSEW")
mySelfObj.address.push("Cleveland, TN")
mySelfObj.address.push("37311")
...
let myPersevereCodeObj2 = {
  wait2: "I object",
  isAnExcellentObject2: true,
  term: 1,
  term: + 1,
  currentScore: 3,
  cumulativeScore: 50,
  cumulativeScore: myPersevereCodeObj.currentScore + myPersevereCodeObj.cumulativeScore,
  "I am exactly this cool": 'soooooo cool'
};
...
console.log(myPersevereCodeObj2)